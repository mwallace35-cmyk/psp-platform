      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="bg-white rounded-xl border border-[var(--psp-gray-200)] p-5 animate-pulse">
              <div className="h-4 w-32 bg-[var(--psp-gray-200)] rounded mb-3" />
              <div className="h-6 w-48 bg-[var(--psp-gray-200)] rounded mb-2" />
              <div className="h-4 w-40 bg-[var(--psp-gray-100)] rounded" />
            </div>
          ))}
        </div>
      </div>
