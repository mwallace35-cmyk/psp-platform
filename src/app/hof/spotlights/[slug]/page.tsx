...
export async function generateStaticParams() {
  return getLegendsByCategory("player-spotlight").map((l) => ({ slug: l.slug }));
}
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://phillysportspack.com/hof/spotlights/${legend.slug}`,
    },
    openGraph: {
      title: `${legend.name} — Legends of Philly HS Sports`,
      description: legend.excerpt,
      type: "article",
      url: `https://phillysportspack.com/hof/spotlights/${legend.slug}`,
    },
  };
}
        ...
        <div className="max-w-7xl mx-auto">
          <Breadcrumb
            items={[
              ...
              { label: "Player Spotlights", href: "/hof/spotlights" },
              { label: legend.name },
            ]}
