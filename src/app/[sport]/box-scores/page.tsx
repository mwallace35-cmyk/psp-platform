      ...
      <>
        ...
        <main id="main-content" className="max-w-7xl mx-auto px-4 py-16 flex-1">
          <div className="text-center bg-gray-50 rounded-lg p-8">
            ...
            <p className="text-gray-600 text-lg">No box scores available for {meta.name} yet.</p>
            <p className="text-gray-500 mt-2">Box scores are being compiled from historical game data.</p>
          </div>
        </main>
      </>
    );
