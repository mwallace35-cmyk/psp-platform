...
export default function WrestlingScheduleView({
  games,
  teams,
  seasons,
  leagueMap,
    ...
    <div className="min-h-[60vh] flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm max-w-lg w-full p-10 text-center">
        ...
        <h2
          ...
          style={{ color: "#ca8a04" }}
        >
          Wrestling &mdash; Coming Soon
        </h2>

        {/* Description */}
        <p className="text-gray-500 text-sm leading-relaxed mb-2">
          Wrestling schedule data is coming soon. Dual meets, tournaments, and
          individual results will appear here.
        </p>

        {/* Future concept pill */}
        <span
          className="inline-block text-xs font-medium px-3 py-1 rounded-full mb-6"
          style={{ backgroundColor: "#ca8a0415", color: "#ca8a04" }}
        >
