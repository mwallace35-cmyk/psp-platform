...
export interface CoachingInitialData {
  staffList: CoachingStaff[];
  schools: School[];
  coaches: Coach[];
}

interface CoachingClientProps {
  initialData?: CoachingInitialData;
}
...
export default function CoachingClient({ initialData }: CoachingClientProps) {
  const router = useRouter();
  const [staffList, setStaffList] = useState<CoachingStaff[]>(initialData?.staffList ?? []);
