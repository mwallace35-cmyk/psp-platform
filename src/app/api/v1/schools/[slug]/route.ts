...
export async function GET(
  ...
  try {
    ...
    const schoolDetail: SchoolDetailResponse = {
      ...
      short_name: schoolData.short_name ?? undefined,
      city: schoolData.city ?? undefined,
      state: schoolData.state ?? undefined,
      mascot: schoolData.mascot ?? undefined,
      website_url: schoolData.website_url ?? undefined,
      founded_year: schoolData.founded_year ?? undefined,
      closed_year: schoolData.closed_year ?? undefined,
